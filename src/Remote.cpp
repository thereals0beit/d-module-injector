    ...
    { 
        ...
        { 
            ...
            { 
                ...
                if( CommitedLibName ) 
                { 
                    unsigned char LoadLibraryAThreadBuffer[ 15 ] = 
                    { 
                    ...
                    *( unsigned long* )( LoadLibraryAThreadBuffer + 0x06 ) = ( unsigned long ) fpLoadLibraryARemote; 
                    ...
                    { 
						...
						GetExitCodeThread( hProcess, &ulReturnValue );
    ...
    { 
        ...
        { 
            ...
            { 
                ...
                { 
                    unsigned char GetProcAddressThreadBuffer[ 20 ] = 
                    { 
                    ...
                    *( unsigned long* )( GetProcAddressThreadBuffer + 0x0B ) = ( unsigned long ) RemoteGetProcAddress; 
                    ...
                    { 
						...
						GetExitCodeThread( hSpawnedThread, ( LPDWORD ) &fpReturnValue );
